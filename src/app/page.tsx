      ...
      <main>
        <section className="bg-[linear-gradient(180deg,#fae8ef_0%,#f3d8e4_100%)] text-[#241915]">
          <div className="mx-auto grid w-full max-w-7xl min-w-0 gap-6 px-4 py-8 sm:px-5 md:px-8 md:py-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.12fr)] lg:items-center lg:gap-10 lg:py-11">
            ...
            <div className="relative w-full max-w-lg justify-self-center overflow-hidden rounded-2xl border border-[#972d3e]/12 bg-surface-elevated/55 shadow-[0_12px_40px_rgba(151,45,62,0.08)] lg:max-w-[28.5rem] lg:justify-self-end xl:max-w-[31.5rem]">
              <Image
        ...
        <section className="border-t border-[#972d3e]/10 bg-background">
          <div className="mx-auto grid w-full max-w-7xl min-w-0 gap-6 px-4 py-9 sm:px-5 md:px-8 md:py-10 lg:grid-cols-2 lg:items-center lg:gap-10">
            ...
            <div className="order-2 min-w-0 lg:order-2">
              <div className="rounded-2xl border border-[#d96889]/20 bg-surface/90 p-6 shadow-[0_8px_32px_rgba(151,45,62,0.06)] md:p-8">
        ...
        <section className="border-t border-[#972d3e]/10 bg-background">
          <div className="mx-auto grid w-full max-w-7xl min-w-0 gap-6 px-4 py-9 sm:px-5 md:px-8 md:py-10 lg:grid-cols-2 lg:items-center lg:gap-10">
            ...
            <div className="order-1 min-w-0 overflow-hidden rounded-2xl border border-[#972d3e]/12 bg-surface-elevated/65 shadow-[0_8px_32px_rgba(151,45,62,0.06)] lg:order-2">
              <Image
        ...
        <section className="border-t border-[#972d3e]/10 bg-background">
          <div className="mx-auto max-w-2xl min-w-0 px-4 py-8 text-center sm:px-5 md:px-8 md:py-10">
            <div className="rounded-2xl border border-[#d96889]/20 bg-surface/95 px-5 py-7 shadow-[0_8px_28px_rgba(151,45,62,0.05)] md:px-8">
